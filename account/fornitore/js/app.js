...
app.controller('ListCtrl',function($scope, $http,$dialogs,$window, $rootScope){
    ...
    //console.log($rootScope.acronimo);
		...
		$http.post(baseUrl +'createnewfile.php',{"nome_disegno_tabella":info.nome_disegno_tabella, "progetto":info.progetto, "linea": info.linea, "numero_disegno_linea":info.numero_disegno_linea,
				"acronimo_linea": $rootScope.acronimo, "plant": info.plant, "modello": info.modello, "rev_tabella": info.rev_tabella, "controllato": info.controllato, "creato": info.creato,"ultima_modifica": info.ultima_modifica, "compilatore": info.compilatore})
		.success(function(data){
		if (data)
     {
			location.reload(); 
 ...
 /* $scope.countries = [
      {name: 'LAS', code: 'Linea Longherone laterale Anteriore Sx. / LH Front Side Member Line.'},
      {name: 'LAD', code: 'RH Front Side Member Line.'},
      {name: 'LAZ', code: 'Linea Longherone laterale Anteriore sx/dx (Linea unica). / LH/RH Front Side Member Line (Only one line)'},
      {name: 'LBS', code: 'Linea preparazione longherone posteriore Sx. / LH preparation Rear Side Member Line.'},
      {name: 'LBD', code: 'Linea preparazione longherone posteriore Dx. / RH preparation Rear Side MemberLine'},
      {name: 'LBZ', code: 'Linea preparazione longherone posteriore sx/dx (Linea unica). / LH/RH preparation Rear Side Member Line'},
      {name: 'LPS', code: 'Linea Longherone laterale Posteriore Sx. / LH Rear Side Member Line'},
      {name: 'LPD', code: 'Linea Longherone laterale Posteriore Dx. / RH Rear Side Member Line.'},
      {name: 'LPZ', code: 'Linea Longherone laterale Posteriore sx/dx (Linea unica). / LH/RH Rear Side Member Line.'},
      {name: 'LLS', code: 'Linea Longherone Laterale Sx. / LH Side Member Line'},
      {name: 'LLD', code: 'Linea Longherone Laterale Dx. / RH Side Member Line.'},
      {name: 'LLZ', code: 'Linea Longherone Laterale sx/dx (Linea unica). / LH/RH Side Member Line.'},
      {name: 'LCZ', code: 'Linea Longherone centrale sx/dx (Linea unica). / LH/RH Centre Side Member Line'},
      {name: 'LCZ', code: 'Linea Longherone Interno sx/dx (Linea unica manuale). / LH/RH Internal Side Member Line'},
      {name: 'LMS', code: 'Linea Longherina Montante parabrezza Sx. / LH Internal Side Member Line'},
      {name: 'LMD', code: 'Linea Longherina Montante parabrezza Dx. / RH Internal Side Member Line'},
      {name: 'LMZ', code: 'Linea Longherina Montante parabrezza sx/dx (Linea unica). / LH/RH Member '},
      {name: 'LMD', code: 'Linea Longherina Montante parabrezza Dx. / RH Internal Side Member Line'},
...
app.controller("OlciHeadCtrl",['$scope','$http', function($scope,$http){
	...
	function getHead()
	{
		$http.post(baseUrl+'data_head.json').success(function(data){
			$scope.data = data;
		});
	}
